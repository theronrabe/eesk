...
#define _translations_h_
	unsigned char c_halt[] = {0x48,0xC7,0xC7,0x00,0x00,0x00,0x00,
				0x49,0x89,0xe5,
				0x4c,0x89,0xfc,
				0x41,0xff,0xd4,
				0x49,0x89,0xe7,
	...
	unsigned char c_jmp[] = {0x58, 0xFF,0xE0, 0xC3, 0xC3};

	unsigned char c_hop[] = {0x58, 0xE8,0x00,0x00,0x00,0x00,
				0x5B, 0x48,0x01,0xD8,
				0xFF,0xE0, 0xC3, 0xC3};

	unsigned char c_brn[] = {0x58, 0x5B, 0x48,0x85,0xC0,
				0x74,0x02,
				0xFF,0xE3,
				0xC3, 0xC3};
	...
	unsigned char c_rpush[] = {0x48,0x8d,0x05,
				0x00,0x00,0x00,0x00,
				0x50,0xC3, 0xC3};

	unsigned char c_grab[] = {0xE8,0x10,0x00,0x00,0x00, 
					0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
					0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
					0xC3, 0xC3};

	unsigned char c_pop[] = {0x5B, 0x58,
				0x48,0x89,0x18,
				0xC3, 0xC3};

	unsigned char c_rpop[] = {0x58, 0x5B,
				0x48,0x89,0x18,
				0xC3, 0xC3};

	unsigned char c_bpop[] = {0x5B, 0x58,
				0x88,0x18,
				0xC3, 0xC3};

	unsigned char c_cont[] = {0x58, 0xFF,0x30, 0xC3, 0xC3};

	unsigned char c_clr[] = {0x58, 0xC3, 0xC3};

	unsigned char c_tjsr[] = {
				0x49,0x8b,0x03,
				0x48,0x85,0xc0,
				0x74,0x35,
	...
	unsigned char c_rsr[] = {0x49,0x89,0xe5,
				0x4c,0x89,0xfc,
					//0x48,0x8b,0x24,0x04,
					//0x48,0x8b,0x00,
				0x41,0x5e,
	...
	unsigned char c_trsr[] = {
				0x4c,0x89,0xf0,
				0x49,0x2b,0x07,
				0x49,0x01,0xc2,

					0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,	//crash
	...
	unsigned char c_aget[] = {0x48,0xB8,
				0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
					//0x49,0x8B,0x5f,0x10,
				0x48,0x29,0xc3,
				0x53,
	...
	unsigned char c_add[] = {0x58,
				0x48,0x01,0x44,0x24,0x00,
				0xC3, 0xC3};

	unsigned char c_sub[] = {0x58,
				0x48,0x29,0x44,0x24,0x00,
				0xC3, 0xC3};

	unsigned char c_mul[] = {0x5B, 0x58,
				0x48,0xF7,0xE3,
				0x50,
				0xC3, 0xC3};

	unsigned char c_div[] = {0x5B, 0x58,
				0x48,0x99,
				0x48,0xF7,0xFB,
				0x50,
				0xC3, 0xC3};

	unsigned char c_mod[] = {0x5B, 0x58,
				0x48,0x99,
				0x48,0xF7,0xFb,
				0x52,
				0xC3, 0xC3};

	unsigned char c_and[] = {0x58,
				0x48,0x21,0x44,0x24,0x00,
				0xC3, 0xC3}; 
	unsigned char c_or[] = {0x58,
	...
	unsigned char c_data[] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 0xC3, 0xC3};
	...
	const unsigned char c_typeof[] = {
					...
					0xc3,0xc3};
				*/
	unsigned char c_typeof[] = {
					0x49,0x8b,0x03,
					0x48,0x89,0x04,0x24,
					0xc3,0xc3};
	
	unsigned char c_tasgn[] = {
					0x48,0xb8,
						0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,
					0x49,0x89,0x03,
					0xc3,0xc3};
	
	unsigned char c_tpop[] = {
					0x49,0x83,0xc3,0x08,
					0xc3,0xc3};
	
	unsigned char c_tval[] = {
					0x49,0xc7,0x03,0x00,0x00,0x00,0x00,
					0xc3,0xc3};
	
	unsigned char c_tset[] = {
					0x49,0xc7,0x03,0x01,0x00,0x00,0x00,
					0xc3,0xc3};
	
	unsigned char c_tdup[] = {
					0x49,0x8b,0x03,
					0x49,0x83,0xeb,0x08,
					0x49,0x89,0x03,
					0xc3,0xc3};
